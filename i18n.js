window.GB_I18N = {
  es: {
    ...
    heroCardFoot: "Human × System → Adopción",
    ...
    valorEyebrow: "EDGE · SEÑAL → SISTEMA → DECISIÓN → HÁBITO",
    ...
    langIndex: "IDIOMAS",
    langEyebrow: "MULTILINGUAL · CS × GLOBAL",
    langH2: "Hablo donde el cliente<br><em>y el equipo</em> están.",
    langP: "Seis idiomas en el radar: nativo, alto y básico — más catalán de comprensión.",
    langEsName: "Español",
    langEsLevel: "Nativo",
    langEnName: "Inglés",
    langEnLevel: "Alto · C1",
  ...
  en: {
    ...
    heroCardFoot: "Human × System → Adoption",
    ...
    valorIndex: "MY EDGE",
    valorEyebrow: "EDGE · SIGNAL → SYSTEM → DECISION → HABIT",
    ...
    langIndex: "LANGUAGES",
    langEyebrow: "MULTILINGUAL · CS × GLOBAL",
    langH2: "I speak where the customer<br><em>and the team</em> are.",
    langP: "Six languages on the board: native, high and basic — plus Catalan comprehension.",
    langEsName: "Spanish",
    langEsLevel: "Native",
    langEnName: "English",
    langEnLevel: "High · C1",
    ...
    langFrLevel: "Basic",
    langCaName: "Catalan",
    langCaLevel: "Understand · don't speak",
