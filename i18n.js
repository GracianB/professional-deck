window.GB_I18N = {
  es: {
    ...
    heroProof: "1 caso live · 3 demos · apps + chatbots LLM · CS × Data × AI",
    ...
    demosIndex: "DEMOS PRIVADAS",
    demosEyebrow: "BAJO SOLICITUD · MÁS INFO O DEMO",
    demosH2: "Tres sistemas.<br><em>Una sola puerta.</em>",
    demosP: "Apps y motores que construí: pricing, matching y outreach. Explora el caso o agenda una demo.",
    demosFoot: "1 live público (Bodytone) · 3 demos bajo solicitud · CS × Data × AI",
    calcBadge: "DEMO PRIVADA",
    calcH2: "Calculadora · <em>200+ reglas</em>",
    priv2p: "Producto, plano, transporte e instalación → propuesta lista para enviar.",
    finderBadge: "DEMO PRIVADA",
    finderH2: "Profile Finder · <em>LinkedIn</em>",
    priv3p: "Nombre y apellidos → coincidencia profesional probable, con validación humana.",
    outreachH2: "Outreach · <em>GenAI + HITL</em>",
    priv4p: "Segmentación + personalización + revisión humana + reporting.",
    proofNote: "No publico bases, credenciales ni tarifas. Enseño impacto y protejo la lógica.",
    routeIndex: "RUTA",
    routeEyebrow: "6 CIUDADES · 4 PAÍSES · MURCIA ↔ GRAN CANARIA",
    ...
    recruiterCards: [
      ...
      ["02", "Prueba", "1 live + 3 demos privadas."],
  ...
  en: {
    ...
    heroProof: "1 live case · 3 demos · apps + LLM chatbots · CS × Data × AI",
    heroVisualHead: "PROFILE / 2026",
    heroOnline: "ONLINE",
    heroCoreSmall: "INTERSECTION",
    heroCoreStrong: "CS × DATA × AI",
    ...
    demosIndex: "PRIVATE DEMOS",
    demosEyebrow: "ON REQUEST · MORE INFO OR DEMO",
    demosH2: "Three systems.<br><em>One doorway.</em>",
    demosP: "Apps I built: pricing, matching and outreach. Explore the case or book a demo.",
    demosFoot: "1 public live (Bodytone) · 3 demos on request · CS × Data × AI",
    calcBadge: "PRIVATE DEMO",
    calcH2: "Calculator · <em>200+ rules</em>",
    priv2p: "Product, floorplan, transport and install → ready-to-send proposal.",
    finderBadge: "PRIVATE DEMO",
    finderH2: "Profile Finder · <em>LinkedIn</em>",
    priv3p: "Name and surname → likely professional match, with human validation.",
    outreachH2: "Outreach · <em>GenAI + HITL</em>",
    priv4p: "Segmentation + personalization + human review + reporting.",
    proofNote: "I don't publish databases, credentials or rates. I show impact and protect the logic.",
    routeIndex: "ROUTE",
    routeEyebrow: "6 CITIES · 4 COUNTRIES · MURCIA ↔ GRAN CANARIA",
    ...
    recruiterCards: [
      ...
      ["02", "Proof", "1 live + 3 private demos."],
